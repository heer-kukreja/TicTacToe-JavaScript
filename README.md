...
Basic assumptions are:
   - Cost of winning for user = -10 (minimizer)
   - cost of winning for computer = +10 (maximizer)
   - cost of a draw for either = 0
 
The Algorithm
   - As its a recursive function the base conditions checks for the win condition:
